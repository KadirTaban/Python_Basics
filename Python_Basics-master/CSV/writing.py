...
with open("cars.csv","w") as file:
    ...
    csv_writer.writerow(["Renault","Fluence"])
    csv_writer.writerow(["Dacia","Sandero"])
    

with open("cars.csv","w") as file:
    csv_writer = writer(file)
    csv_writer.writerows([["Marka","Model"],["Toyota","Corolla"],["Dacia","sandero"]])#writerow ile writerows arasındaki fark writerow direkt liste yapar
#########################################
ürün ekleme.
